...
const  URL_API_POKEMON = "https://pokeapi.co/api/v2/pokemon?limit=40";      //el query es una limitación -> 40 pokemones.
const URL_API_POKEMON_NAME_OR_ID = "https://pokeapi.co/api/v2/pokemon/";


//·Obtengo los ponemones de la Api:
...
//·Obtengo pokes de la base de datos:
...
//·Permite obtener pokemon por id:
